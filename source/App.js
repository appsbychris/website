...
enyo.kind({
	...
	components:[
		{kind: "FittableColumns", style: "width:100%;", components: [
			...
			{kind: "FittableRows", style: "padding:3px;", components: [
				{content: "Apps By Chris", classes: "main-header", style: "margin-bottom:5px;"},
		...
		{kind: "expandable.RadioGroup", name: "radioGroup", components: [
			{ classes: "onyx-affirmative", ontap: "changePanels", index: 0, content: "Blog", active: true},
			{ classes: "onyx-affirmative", ontap: "changePanels", index: 1, content: "Slideshow HD"},
			{ classes: "onyx-affirmative", ontap: "changePanels", index: 2, content: "Chore Tracker"},
		
			{ classes: "onyx-affirmative", ontap: "changePanels", index: 3, content: "Peek-A-Dash"},
			{ classes: "onyx-affirmative", ontap: "changePanels", index: 4, content: "Two Outta Three"}
		]},
		{kind: "Panels", name:"panels", fit:true,realtimeFit: true, onTransitionFinish: "setIndex",  arrangerKind: "CollapsingArranger", classes: "enyo-border-box", components: [
	...
	setIndex: function() {
		var c = this.$.radioGroup.getClientControls();
		for (var i = 0; i < c.length; i++) {
			if (c[i].index == this.$.panels.getIndex()) {
				this.$.radioGroup.setActive(c[i]);
				break;
			}
		}
	}
