...
enyo.kind({
	...
	applyZIndex: function() {
		...
		if (this._zIndex <= onyx.Popup.highestZ) {this._zIndex = onyx.Popup.highestZ+1;}
		if (this._zIndex > onyx.Popup.highestZ) {onyx.Popup.highestZ = this._zIndex;}
	...
	findZIndex: function() {
		...
		if (z < this.defaultZ) {z = this.defaultZ;}
